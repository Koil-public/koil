package com.spirit.koil.chat.api;
...
/** Persistent client preferences for optional Rich Chat presentation features. */
public final class RichChatSettings {
    ...
    /** Mirrors Minecraft's Chat Colors setting for Koil-owned text colours. */
