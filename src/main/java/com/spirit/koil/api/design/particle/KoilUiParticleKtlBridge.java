 ...
 */
public final class KoilUiParticleKtlBridge {
    private KoilUiParticleKtlBridge() { }

    public static String registerJsonEffect(String json) {
        return KoilUiParticleJsonLoader.registerJson(json);
    }

    public static boolean trigger(KoilUiParticleEngine engine, String effectId) {
        return trigger(engine, effectId, 1.0F);
    }

    public static boolean trigger(KoilUiParticleEngine engine, String effectId, float scale) {
