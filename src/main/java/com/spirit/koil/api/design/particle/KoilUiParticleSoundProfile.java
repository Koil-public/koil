 ...
 */
public final class KoilUiParticleSoundProfile {
    ...
    private KoilUiParticleSoundProfile(Builder builder) {
    ...
    public static KoilUiParticleSoundProfile forBlock(Block block) {
        return forBlock(block, true);
    }

    public static KoilUiParticleSoundProfile forBlock(Block block, boolean breakOnExpire) {
    ...
    public static KoilUiParticleSoundProfile forBouncingBlock(Block block) {
        if (block == null) return builder().build();
        BlockSoundGroup group = block.getDefaultState().getSoundGroup();
        float volume = Math.max(0.08F, group.getVolume());
        float pitch = Math.max(0.25F, group.getPitch());
    ...
    public static final class Builder {
        ...
        public KoilUiParticleSoundProfile build() { return new KoilUiParticleSoundProfile(this); }
    }
}
