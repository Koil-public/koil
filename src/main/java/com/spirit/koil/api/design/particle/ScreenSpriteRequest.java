...
public record ScreenSpriteRequest(String id, int x, int y, int count, float scale, String overrides) {
    ...
    public ScreenSpriteRequest {
        id = id == null ? "" : UiParticleRegistry.canonicalId(id.strip().toLowerCase(Locale.ROOT));
    ...
    public static ScreenSpriteRequest cursor(String id, int count, float scale) {
        return cursor(id, count, scale, "");
    }

    public static ScreenSpriteRequest cursor(String id, int count, float scale, String overrides) {
        return new ScreenSpriteRequest(id, CURSOR, CURSOR, count, scale, overrides);
    }

    public static ScreenSpriteRequest at(String id, int x, int y, int count, float scale) {
        return at(id, x, y, count, scale, "");
    }

    public static ScreenSpriteRequest at(String id, int x, int y, int count, float scale, String overrides) {
        return new ScreenSpriteRequest(id, x, y, count, scale, overrides);
    }

    public boolean cursor() { return x == CURSOR; }

    public boolean valid() {
        return !id.isBlank() && UiParticleRegistry.contains(id);
    }
