 ...
 */
public final class KoilUiParticleWidgetProfileRegistry {
    ...
    private KoilUiParticleWidgetProfileRegistry() { }
    ...
    public static void apply(KoilUiParticleEngine engine, String id) {
        ...
        if (profile.themeId() != null && !profile.themeId().isBlank()) KoilUiParticleThemeRegistry.apply(engine, profile.themeId());
