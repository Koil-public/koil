 ...
 */
public final class KoilUiParticleSoundLibrary {
    private KoilUiParticleSoundLibrary() { }
    ...
    public static KoilUiParticleSoundProfile.Cue cue(
            String path,
            float volume,
            float pitch,
            float jitter,
        ...
        return new KoilUiParticleSoundProfile.Cue(sound(path), volume, pitch, jitter, cooldownMs);
    }
}
