...
public class uiColorVal {
    ...
    public static int uiColorLocalModelMessageBar;
    public static int uiColorLocalModelPopupBackground;
    public static int uiColorLocalModelPopupBorder;
    public static int uiColorLocalModelPopupAccent;
    public static int uiColorLocalModelPopupText;
    public static int uiColorLocalModelPopupSecondaryText;
    public static int uiColorLocalModelSetupRowBackground;
    public static int uiColorLocalModelSetupRowBorder;
    public static int uiColorLocalModelSetupSelectedBackground;
    public static int uiColorLocalModelSetupSelectedBorder;
    public static int uiColorAutomationModePopupBackground;
    public static int uiColorAutomationModePopupBorder;
    public static int uiColorAutomationModePopupAccent;
    public static int uiColorAutomationModePopupText;
