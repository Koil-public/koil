 ...
 */
public final class KoilUiParticleMaterials {
    private KoilUiParticleMaterials() { }
    ...
    public static void apply(Material material, KoilUiParticleEngine.ParticleBuilder builder) {
