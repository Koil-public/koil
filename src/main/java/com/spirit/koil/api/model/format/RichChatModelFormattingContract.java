...
public final class RichChatModelFormattingContract {
    ...
    public static String systemPrompt() {
        return """
            ...
            - Structure: # through ###### headings, - or numbered lists, > or >>> quotes, -# secondary text, compact Markdown tables, fenced code with a language, links, media URLs, spoilers, and LaTeX.
            ...
            - Put §f after a structural prefix, never before it: `- §fitem`, `> §fquote`, `# §fheading`, `1. §fstep`, and `| §fcell |`. Do not place section codes inside Markdown delimiters themselves.
            - Semantic colors: §a verified success or completion; §c failure, rejection, or blocking error; §6 active or planned work; §5 revision or replanning; §e warning or uncertainty; §8 metadata or secondary evidence. Use §f for normal text. Never use §a before success is verified.
            ...
            - Section formatting may appear in visible headings, list text, quotes, -# subtext, table cells, spoilers, and link labels. Never place it in a URL, hidden link or command target, identifier, file path, code token, JSON value, command syntax, LaTeX source, or fenced source where literal accuracy matters.
            ...
            - Code belongs in fenced blocks with an accurate language when multiple lines are required. Keep code small. Do not put a Markdown table or masked command link inside a code fence.
            - Math: `$...$` or `\\(...\\)` inline; `$$...$$`, `\\[...\\]`, or fenced `latex`/`tex` for blocks. There is no separate LaTeX document type.
            ...
            - Formatting is for visible output and safe visible summaries only. Never format or reveal hidden reasoning.
            """;
    }
